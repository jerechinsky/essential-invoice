...
# Remote Docker host: copy deploy.env.example to deploy.env, then ./deploy.sh
```
...
- **Services**: `services/` - Business logic:
  ...
  - `universalInvoiceParser.ts` - Strict parser and arithmetic validator for human-readable, multi-invoice expense imports matched to source files by exact filename
